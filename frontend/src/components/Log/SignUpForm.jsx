      ...
      case 2:
        ...
        if (!username && !email) {
          ...
          if (username.match(usernameRegex)) {
            if (Array.from(usersData).find((user) => user.username === username)) setUsernameError("Ce nom d'utilisateur est déjà utilisé");
            setEmailError('Veuillez indiquer votre adresse email');
          } else {
            setEmailError('Veuillez indiquer votre adresse email');
          ...
          <Form onSubmit={(e) => handleRegister(e)}>
            <FormWrapper>
              ...
              <Checkbox id='terms' error={termsError}>
                <span>
                  J'ai lu et j'accepte les <Link>conditions d'utilisation</Link> et la <Link>Politique de confidentialité</Link>
                </span>
              </Checkbox>
            </FormWrapper>
